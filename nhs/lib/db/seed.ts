...
export async function seedDb(): Promise<void> {
  ...
  await db.run(`
    ...
    (7, 'MRN001', '1980-05-15', 'male', 'O+', '123 Main St, Nairobi', '+254712345678', 'Jane Doe', '+254712345679'),
    (8, 'MRN002', '1990-10-20', 'female', 'A-', '456 Park Ave, Nairobi', '+254723456789', 'John Smith', '+254723456780')
  `)
