  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold mb-4">Total Revenue: $48,395</div>
          <table className="w-full">
            ...
            <tbody>
              {[
                { department: "Inpatient Services", revenue: "$32,105", percentage: "66.3%", change: "+5.2%" },
                { department: "Outpatient Services", revenue: "$14,290", percentage: "29.5%", change: "+12.8%" },
                { department: "Pharmacy", revenue: "$2,000", percentage: "4.2%", change: "-3.1%" },
              ].map((item, index) => (
